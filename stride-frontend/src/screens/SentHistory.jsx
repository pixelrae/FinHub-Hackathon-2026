...
import { getSentHistory } from "../api/index.js";
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.summaryCard}>
                <p style={styles.summaryLabel}>Total Paid for period</p>
                <p style={styles.summaryAmount}>R {total.toFixed(2)}</p>
